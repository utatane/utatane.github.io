    ...
    var header_scroll = '';
        header_scroll += '<div class="container">';
            header_scroll += '<div class="row header_scroll_pc">';
                header_scroll += '<div class="col-xs-4 utatane_logo"><a href="KomabaFes2018.html"><img src="./pictures/UTaTane_icon_moji.png" alt="UTaTane"></a></div>';
                header_scroll += '<div class="col-xs-8 nav"><div><span style="word-spacing: normal;"><a href="livingroom.html">Living&nbsp;Room</a></span> | <a href="kitchen.html">Kitchen</a> | <span style="word-spacing: normal;"><a href="study.html">Study&nbsp;Room</a></span></div></div>';
        ...
        html += '<div class="header_default">';
            html += '<div class="container">';
                ...
                html += '<div class="header_sp">';
                    html += '<div class="row">';
                        html += '<div class="col-xs-12 utatane_icon"><a href="KomabaFes2018.html"><img src="./pictures/UTaTane_icon.png" alt="UTaTane"></a></div>';
                    html += '</div>';
                html += '</div>'; // header_sp

                html += '<div class="row header_pc">';
                    html += '<div class="col-xs-4 utatane_icon"><a href="KomabaFes2018.html"><img src="./pictures/UTaTane_icon.png" alt="UTaTane"></a></div>';
                    html += '<div class="col-xs-8 nav"><nav><span style="word-spacing: normal;"><a href="livingroom.html">Living&nbsp;Room</a></span> | <a href="kitchen.html">Kitchen</a> | <span style="word-spacing: normal;"><a href="study.html">Study&nbsp;Room</a></span></nav></div>';
                html += '</div>'; // header_pc
...
function menulist_appear()
{
  ...
  menulist = '';
  menulist += '<table>';
    menulist += '<tr><td><a href="KomabaFes2018.html" onclick="menulist_disappear()">Top</tr></a></td>';
    menulist += '<tr><td><a href="livingroom.html" onclick="menulist_disappear()">Living&nbsp;Room</tr></a></td>';
    menulist += '<tr><td><a href="kitchen.html" onclick="menulist_disappear()">Kitchen</tr></a></td>';
    menulist += '<tr><td><a href="study.html" onclick="menulist_disappear()">Study&nbsp;Room</tr></a></td>';
  menulist += '</table>';
