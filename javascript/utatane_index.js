    ...
    var header_index_scroll = '';
        header_index_scroll += '<div class="container">';
            header_index_scroll += '<div class="row header_scroll_pc">';
                ...
                header_index_scroll += '<div class="col-xs-8 index_nav"><div><a href="#top">Top</a> | <a href="#about">About</a> | <a href="#concept">Concept</a> | <a href="#news">News</a> | <a href="#works">Works</a> | <a href="#contact">Contact</a></div></div>';
...
//                    html += '<div class="col-xs-4 utatane_icon"><a href="https://mayfes2018-utatane.com"><img src="./pictures/UTaTane_icon.png" alt="UTaTane"></a></div>';
                    ...
                    html += ref;
                    html += '><img src="./pictures/UTaTane_icon.png" alt="UTaTane"></a></div>';
                    html += '<div class="col-xs-8 index_nav"><div><a href="#top">Top</a> | <a href="#about">About</a> | <a href="#concept">Concept</a> | <a href="#news">News</a> | <a href="#works">Works</a> | <a href="#contact">Contact</a></div></div>';
                html += '</div>'; // header_pc
