    ...
    var header_index_scroll = '';
        header_index_scroll += '<div class="container">';
            header_index_scroll += '<div class="row header_scroll_pc">';
                ...
                header_index_scroll += '<div class="col-xs-9 index_nav"><div><a href="#top">Top</a> | <a href="#concept">Concept</a> | <a href="#contents">Contents</a> | <a href="#contact">Contact</a></div></div>';
...
//                    html += '<div class="col-xs-4 utatane_icon"><a href="https://mayfes2018-utatane.com"><img src="./pictures/UTaTane_icon.png" alt="UTaTane"></a></div>';
                    ...
                    html += ref;
                    html += '><img src="../../pictures/UTaTane_icon.png" alt="UTaTane"></a></div>';
                    html += '<div class="col-xs-9 index_nav"><div><a href="#top">Top</a> | <a href="#concept">Concept</a> | <a href="#contents">Contents</a> | <a href="#contact">Contact</a></div></div>';
                html += '</div>'; // header_pc
...
function menulist_index_appear()
{
  ...
  menulist_index += '<table>';
    ...
    menulist_index += '<tr><td><a href="#contents" onclick="menulist_index_disappear()">Contents</tr></a></td>';
